        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="#">Riwayat Sampah</a></div>
                    <div class="breadcrumb-item">All Riwayat Sampah</div>
                </div>
            </div>
            <div class="section-body">
                <h2 class="section-title">Riwayat Sampah</h2>
                <p class="section-lead">
                    You can manage all Riwayat Sampah, such as editing, deleting and more.
                </p>
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
